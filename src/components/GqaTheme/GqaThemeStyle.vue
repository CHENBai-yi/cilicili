<template>
  <div class="row q-gutter-md">
    <q-btn v-for="(value, key, index) in themeStyleList" :key="index" class="q-hoverable cursor-pointer text-center"
           @click="setThemeStyle(key)">
      <div class="column items-center">
        <q-icon v-if="themeStyle === key" class="absolute all-pointer-events" color="negative" name="check_box"
                size="25px" style="top: 2px; right: 2px"/>
