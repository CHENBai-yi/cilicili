            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="operation" :props="props">
                  <q-btn color="red" flat label="取消审核"></q-btn>
                </q-td>
              </q-tr>
              <q-tr>
                <q-td class="wrap" colspan="100%">
                  {{ props.row.desc }}
                </q-td>
              </q-tr>
            </template>
          ...
          >
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="operation" :props="props">
                  <q-btn color="primary" flat label="查看审核结果">
                  </q-btn>
                  <q-btn color="red" flat label="删除该课程">
                  </q-btn>
                </q-td>
              </q-tr>
            </template>
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="operation" :props="props">
                  ...
                  <q-btn color="red" flat label="查看原因"/>
                </q-td>
              </q-tr>
            </template>
          </q-table>
