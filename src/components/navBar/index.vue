<template>
  <q-header class="bg-white text-grey-8 q-py-xs  " elevated height-hint="58">
    <q-toolbar>
      <q-space/>
      <q-btn v-if="$q.screen.gt.sm" class="q-ml-xs no-pointer-events" fab-mini flat no-caps no-wrap>
      ...
      <div class="YL__toolbar-input-container row no-wrap">
        <q-input
          v-model="search"
          class="q-ml-md"
          clearable debounce="500" dense placeholder="请输入关键词" standout="bg-grey-7 text-white">
      ...
      <div class="q-gutter-sm row items-center no-wrap">
        ...
        <CiliPopover clClass="shadow-up-3" clStyle="background: #2093da; color: white" label="登录" to="/keceng">
          <template #default>
            <div class="v-popover is-bottom">
              <div class="v-popover-content">
                <div class="login-panel-popover"><p class="title">登录后你可以：</p>
                  <div class="login-tip-content">
                    <div class="login-tip-content-item">
                      ...
                      <span class="lt-text">免费看高清视频</span></div>
                    <div class="login-tip-content-item">
                      <svg class="login-tip-content-item-icon" fill="currentColor"
                           height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"
                           xmlns:xlink="http://www.w3.org/1999/xlink">
                      ...
                      <span class="lt-text">多端同步播放记录</span></div>
                    <div class="login-tip-content-item">
                      <svg class="login-tip-content-item-icon" fill="currentColor"
                           height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"
                           xmlns:xlink="http://www.w3.org/1999/xlink">
                      ...
                      <span class="lt-text">发表弹幕/评论</span></div>
                    <div class="login-tip-content-item">
                      <svg class="login-tip-content-item-icon" fill="currentColor"
                           height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"
                           xmlns:xlink="http://www.w3.org/1999/xlink">
                      ...
                      <span class="lt-text">热门番剧影视看不停</span></div>
                  </div>
                  <div class="login-btn">立即登录</div>
                  <div class="register-tip"> 首次使用？ <span class="register-exper"> 点我注册 </span></div>
                </div>
              </div>
            </div>
          </template>
        ...
        <CiliPopover v-if="$q.screen.gt.sm" label="消息" name="notifications">
          <template #badge>
          ...
          <template #default>
            <div class="v-popover is-bottom">
              <div class="v-popover-content">
                <div class="login-panel-popover"><p class="tips">登录即可查看消息记录</p>
                  <div class="login-btn"> 立即登录</div>
                </div>
              </div>
            </div>
        ...
        <CiliPopover v-if="$q.screen.gt.sm" label="收藏" name="hotel_class">
          <template #default>
            <div class="v-popover is-bottom">
              <div class="v-popover-content">
                <div class="login-panel-popover"><p class="tips">登录即可查看我的收藏</p>
                  <div class="login-btn"> 立即登录</div>
                </div>
              </div>
            </div>
        ...
        <CiliPopover v-if="$q.screen.gt.sm" label="观看历史" name="access_time">
          <div class="v-popover is-bottom">
            <div class="v-popover-content">
              <div class="login-panel-popover"><p class="tips">登录即可查看历史记录</p>
                <div class="login-btn"> 立即登录</div>
              </div>
            </div>
          </div>
        ...
        <CiliPopover label="投稿" name="cloud_upload">
          <div class="">
            <div class="">
