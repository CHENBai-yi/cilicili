<template>
  <div>
    <q-input v-model="showName" :class="className" :label="label || $t('Selete') + $t('User')" :outlined="outlined"
             readonly>
      <template v-slot:append>
        <q-btn :label="$t('Select')" color="primary" dense @click="showSelectUserDialog"/>
      </template>
    </q-input>
