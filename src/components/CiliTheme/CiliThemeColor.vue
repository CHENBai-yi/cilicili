<template>
  <div>
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="primary === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="secondary === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="accent === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="positive === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="negative === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="info === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="warning === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="light === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
    ...
    <q-field label-slot stack-label>
      ...
      <template v-slot:control>
        <div class="q-gutter-md q-ma-none">
          <q-avatar v-for="(item, index) in colorList" :key="index" :size="dark === item ? 'md' : 'xs'"
                    :style="{ border: '1px solid grey', background: item }"
                    class="cursor" round
