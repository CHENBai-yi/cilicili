      ...
      <q-card-section>
        ...
        <q-form ref="recordDetailForm">
          <div class="row q-gutter-md">
            ...
            <q-input v-model="recordDetail.value.memo" :label="$t('Describe')" class="col" hint=""
                     outlined/>
          </div>
          <div class="row q-gutter-md">
            <q-input v-model="recordDetail.value.config_item" :label="$t('Config') + $t('Item')"
                     :rules="[val => val && val.length > 0 || $t('FixForm')]" class="col"
                     hint=""
                     outlined/>

            <q-input v-model="recordDetail.value.item_default" :label="$t('Default')"
                     :rules="[val => val && val.length > 0 || $t('FixForm')]" class="col"
                     hint="" outlined/>
          </div>
          <q-field :label="$t('On') + $t('Off')" hint="" outlined stack-label>
