  ...
  <q-page padding>
    <q-card flat>
      <q-card-section class="row q-gutter-x-md items-center">
        <q-btn v-has="'dict:addParent'" :label="$t('Add') + $t('Parent') + $t('Dict')" color="primary"
          ...
          <template v-slot:body="props">
            ...
            <td class="text-center q-gutter-x-md">
              ...
              <q-btn-dropdown :label="$t('More')" color="primary" dense flat menu-anchor="bottom left"
                              menu-self="top left">
                <q-list dense>
                  <q-item v-close-popup v-has="'dict:addChildren'" clickable
                  ...
                  <q-item v-close-popup v-has="'dict:delete'" clickable @click="handleDelete(props.item)">
                    <q-item-section>
