  ...
  <q-dialog v-model="nicknameDialog" persistent>
    <q-card style="min-width: 450px">
      ...
      <q-card-section class="q-pt-none">
        <q-form ref="nicknameFormRef" class="q-gutter-md">
          <q-input v-model.trim="nicknameForm.nickname" :label="$t('New') + ' ' + $t('Nickname')"
      ...
      <q-card-actions align="right" class="text-primary">
        ...
        <q-btn :label="$t('Save')" flat @click="handleChangeNickname"/>
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
