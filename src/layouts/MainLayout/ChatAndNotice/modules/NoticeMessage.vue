<template>
  <div>
    <q-list bordered separator style="min-width: 300px">
      <q-item v-for="(item, index) in messageData" :key="index" v-ripple clickable @click="toNoticeDetail(item)">
    ...
    <q-item v-ripple class="text-center" clickable @click="toUserProfile">
      <q-item-section>
        {{ $t('ViewAll') }}
      </q-item-section>
    </q-item>
