                ...
                .authorizeHttpRequests(authorizeHttpRequests -> {
                    authorizeHttpRequests
                            .requestMatchers(
                                    ...
                                    AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/**/*.ico"),
                                    AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/**/*.html"),
                                    ...
                                    AntPathRequestMatcher.antMatcher("/courses/**"),
                                    AntPathRequestMatcher.antMatcher("/subject/**"),
                                    AntPathRequestMatcher.antMatcher("/category/**"),
                                    AntPathRequestMatcher.antMatcher("/user/**"),
                                    AntPathRequestMatcher.antMatcher("/public/**"),
                                    AntPathRequestMatcher.antMatcher("/comments/list_comments"),
                                    AntPathRequestMatcher.antMatcher("/upload/upload-video"))
                            .permitAll()
                            .requestMatchers(
                                    AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/video/**"),
                                    AntPathRequestMatcher.antMatcher(
                                            HttpMethod.GET,
