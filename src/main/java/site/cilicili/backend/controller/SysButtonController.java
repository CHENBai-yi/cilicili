...
public class SysButtonController {
    ...
    @GetMapping
    public R queryAll(final SysButton sysButton) {
    ...
    @Operation(summary = "新增数据", parameters = {
            @Parameter(description = "sysButton 实体")
    })
    @PostMapping
    public R add(final @RequestBody SysButton sysButton) {
    ...
    @PutMapping
    public R edit(final @RequestBody SysButton sysButton) {
