...
public class UploadServiceImpl implements UploadService {
                            ...
                            final List<String> list1 = Arrays.stream(multipartFiles)
                                    .map(item -> {
                                        try {
                                            ...
                                            ClassPathResource resource = new ClassPathResource(getStorePath(
                                                    webMvcConfig.getAvatarPrefix(),
                                            ...
                                            final String avatar = getAvatarPath(
                                                    webMvcConfig.getAvatarPrefix(),
                                                    webMvcConfig.getAvatarRequestPath(),
                                                    authUserDetails.getUsername(),
                                                    fileName);
    ...
    private String getStorePath(
            String prefix, String requestPath, String fileName, String username, SysUserEntity userEntity) {
