...
@Schema(description = "SysGenPluginList数据传输类")
public class SysGenPluginListDto implements Serializable {
    private static final long serialVersionUID = 325521166379192975L;
    List<Long> ids;
