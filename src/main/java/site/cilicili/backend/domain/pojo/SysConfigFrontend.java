...
@Schema(description = "SysConfigFrontend实体类")
public class SysConfigFrontend implements Serializable {
    private static final long serialVersionUID = 890356862588398895L;
