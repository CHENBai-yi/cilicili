/*
 ...
 Source Server         : chenbaiyi@8.217.182.161
 Source Server Type    : MySQL
 Source Server Version : 80027
 Source Host           : 8.217.182.161:3306
...
VALUES (5, 'jdbc:mysql://8.217.182.161:3306', 'root', '74521CBy', 'com.mysql.cj.jdbc.Driver', 'quasar-admin');
...
INSERT INTO `sys_config_backend`
VALUES (9, '2023-12-04 13:02:17', 'admin', '2024-01-22 11:37:20', 'admin', NULL, 9, 'yesNo_yes', 'onOff_on',
        '头像最大上传(M)', 'avatarMaxSize', '3', '5');
INSERT INTO `sys_config_backend`
VALUES (10, '2023-12-04 13:02:17', 'admin', '2023-12-04 13:02:58', '', NULL, 10, 'yesNo_yes', 'onOff_on',
...
VALUES (1, '2023-12-04 13:02:17', 'admin', '2024-01-23 13:52:49', 'admin', NULL, 1, 'yesNo_yes', 'onOff_on', '首页大图',
        'bannerImage', '', 'gqa-upload:banner/bannerImage/fa93ade022494fdf93537bf39e6c4113_20240123135245931.png');
INSERT INTO `sys_config_frontend`
...
INSERT INTO `sys_config_frontend`
VALUES (4, '2023-12-04 13:02:17', 'admin', '2024-01-23 07:43:19', 'admin', NULL, 4, 'yesNo_yes', 'onOff_on', '网站描述',
        'webDescribe', 'Lorem ipsum dolor sit amet consectetur adipisicing elit', '一家专注做视频课程的网站');
INSERT INTO `sys_config_frontend`
VALUES (5, '2023-12-04 13:02:17', 'admin', '2024-01-23 07:43:59', 'admin', NULL, 5, 'yesNo_yes', 'onOff_on',
        '登录页风格', 'loginLayoutStyle', 'loginLayoutStyle_login', 'loginLayoutStyle_portal');
INSERT INTO `sys_config_frontend`
...
VALUES (8, '2023-12-04 13:02:17', 'admin', '2023-12-04 13:02:58', '', NULL, 8, 'yesNo_yes', 'onOff_on', '网站favicon',
        'favicon', '', '');
INSERT INTO `sys_config_frontend`
VALUES (9, '2023-12-04 13:02:17', 'admin', '2024-01-23 13:52:39', 'admin', NULL, 9, 'yesNo_yes', 'onOff_on',
        '显示仓库入口', 'showGit', 'yesNo_yes', 'yesNo_no');
INSERT INTO `sys_config_frontend`
...
VALUES (13, '2024-01-22 10:03:02', 'admin', '2024-01-22 10:40:05', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (iPhone; CPU iPhone OS 16_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.5.1 Mobile/15E148 Safari/604.1',
        'SuperAdmin', '117.136.15.5', 'Safari 16.5.1', 'iPhone', 'iPhone', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (14, '2024-01-22 10:40:08', 'admin', '2024-01-22 10:47:41', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (iPhone; CPU iPhone OS 16_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.5.1 Mobile/15E148 Safari/604.1',
        'SuperAdmin', '117.136.15.5', 'Safari 16.5.1', 'iPhone', 'iPhone', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (15, '2024-01-22 10:49:25', 'admin', '2024-01-22 11:00:52', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (iPhone; CPU iPhone OS 16_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.5.1 Mobile/15E148 Safari/604.1',
        'SuperAdmin', '117.136.15.5', 'Safari 16.5.1', 'iPhone', 'iPhone', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (16, '2024-01-22 11:35:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (17, '2024-01-22 11:35:47', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (18, '2024-01-22 11:36:09', 'admin', '2024-01-22 11:36:18', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'SuperAdmin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (19, '2024-01-22 11:36:23', 'admin', '2024-01-22 11:39:24', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'SuperAdmin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (20, '2024-01-22 11:50:42', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (21, '2024-01-22 11:53:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (22, '2024-01-22 11:53:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (23, '2024-01-22 11:53:29', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (24, '2024-01-22 11:53:31', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (25, '2024-01-22 11:53:33', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (26, '2024-01-22 12:03:55', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (27, '2024-01-22 12:03:57', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (28, '2024-01-22 12:03:58', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (29, '2024-01-22 12:19:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 Edg/120.0.0.0',
        'admin', '117.136.15.5', 'MSEdge 120.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (30, '2024-01-22 12:20:00', 'admin', '2024-01-22 12:20:12', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 Edg/120.0.0.0',
        'SuperAdmin', '117.136.15.5', 'MSEdge 120.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (31, '2024-01-22 12:20:15', 'admin', '2024-01-22 12:21:02', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 Edg/120.0.0.0',
        'SuperAdmin', '117.136.15.5', 'MSEdge 120.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (32, '2024-01-22 14:48:49', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (33, '2024-01-22 14:49:03', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'admin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (34, '2024-01-22 14:49:23', 'admin', '2024-01-22 14:50:06', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:121.0) Gecko/20100101 Firefox/121.0', 'SuperAdmin',
        '117.136.15.5', 'Firefox 121.0', 'Windows 10 or Windows Server 2016', 'Windows', 'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (35, '2024-01-23 07:10:04', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (iPhone; CPU iPhone OS 16_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/119.0.2151.105 Version/16.0 Mobile/15E148 Safari/604.1',
        'admin', '223.104.217.16', 'MSEdge null', 'iPhone', 'iPhone', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (36, '2024-01-23 07:11:14', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (iPhone; CPU iPhone OS 16_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.5.1 Mobile/15E148 Safari/604.1',
        'admin', '223.104.217.16', 'Safari 16.5.1', 'iPhone', 'iPhone', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (37, '2024-01-23 07:11:23', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (iPhone; CPU iPhone OS 16_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/119.0.2151.105 Version/16.0 Mobile/15E148 Safari/604.1',
        'admin', '223.104.217.16', 'MSEdge null', 'iPhone', 'iPhone', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (38, '2024-01-23 07:11:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '该账号已在别处登录！ Mozilla/5.0 (iPhone; CPU iPhone OS 16_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/119.0.2151.105 Version/16.0 Mobile/15E148 Safari/604.1',
        'admin', '223.104.217.16', 'MSEdge null', 'iPhone', 'iPhone', 'yesNo_no');
INSERT INTO `sys_log_login`
VALUES (39, '2024-01-23 07:36:35', 'admin', '2024-01-23 07:39:00', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36',
        'SuperAdmin', '223.104.217.16', 'Chrome 121.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows',
        'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (40, '2024-01-23 07:39:24', 'admin', '2024-01-23 07:41:06', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36',
        'SuperAdmin', '223.104.217.16', 'Chrome 121.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows',
        'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (41, '2024-01-23 07:41:28', 'admin', '2024-01-23 07:43:28', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36',
        'SuperAdmin', '223.104.217.16', 'Chrome 121.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows',
        'yesNo_yes');
INSERT INTO `sys_log_login`
VALUES (42, '2024-01-23 07:43:46', 'admin', '2024-01-23 07:44:06', NULL, NULL, 1, 'yesNo_no', 'onOff_on',
        '登录成功. Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36',
        'SuperAdmin', '223.104.217.16', 'Chrome 121.0.0.0', 'Windows 10 or Windows Server 2016', 'Windows',
        'yesNo_yes');
...
VALUES (1, '2024-01-22 10:02:51', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/init-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (2, '2024-01-22 10:02:52', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (3, '2024-01-22 10:02:52', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (4, '2024-01-22 10:02:52', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (5, '2024-01-22 10:02:52', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (6, '2024-01-22 10:02:53', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (7, '2024-01-22 10:03:02', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (8, '2024-01-22 10:03:03', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (9, '2024-01-22 10:03:04', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (10, '2024-01-22 10:03:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (11, '2024-01-22 10:03:10', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (12, '2024-01-22 10:03:16', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (13, '2024-01-22 10:03:16', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (14, '2024-01-22 10:05:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (15, '2024-01-22 10:05:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (16, '2024-01-22 10:06:15', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (17, '2024-01-22 10:39:58', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (18, '2024-01-22 10:40:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (19, '2024-01-22 10:40:06', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (20, '2024-01-22 10:40:06', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (21, '2024-01-22 10:40:09', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (22, '2024-01-22 10:40:12', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (23, '2024-01-22 10:40:14', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (24, '2024-01-22 10:40:16', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (25, '2024-01-22 10:40:16', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (26, '2024-01-22 10:40:20', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (27, '2024-01-22 10:40:20', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (28, '2024-01-22 10:40:24', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (29, '2024-01-22 10:40:45', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (30, '2024-01-22 10:40:55', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (31, '2024-01-22 10:41:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (32, '2024-01-22 10:41:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (33, '2024-01-22 10:41:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (34, '2024-01-22 10:41:25', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (35, '2024-01-22 10:46:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (36, '2024-01-22 10:46:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (37, '2024-01-22 10:46:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (38, '2024-01-22 10:46:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (39, '2024-01-22 10:47:41', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (40, '2024-01-22 10:47:42', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (41, '2024-01-22 10:47:42', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (42, '2024-01-22 10:47:48', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'java.io.IOException: Broken pipe', 'anonymousUser', '117.136.15.5', 'POST', '/public/get-dict-all', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"java.io.IOException: Broken pipe\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (43, '2024-01-22 10:49:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (44, '2024-01-22 10:49:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (45, '2024-01-22 10:49:31', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (46, '2024-01-22 10:49:36', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (47, '2024-01-22 10:49:36', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (48, '2024-01-22 10:49:41', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (49, '2024-01-22 10:50:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (50, '2024-01-22 10:50:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Failed to parse multipart servlet request', 'SuperAdmin', '117.136.15.5', 'POST', '/upload/upload-avatar', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"Failed to parse multipart servlet request\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (51, '2024-01-22 10:59:51', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (52, '2024-01-22 10:59:56', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '104.234.0.191', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (53, '2024-01-22 11:00:45', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '104.234.0.191', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (54, '2024-01-22 11:00:45', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '104.234.0.191', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (55, '2024-01-22 11:00:53', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '服务器有点呆。。。', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/logout', 200, '{\"code\":0,\"message\":\"服务器有点呆。。。\"}');
INSERT INTO `sys_log_operation`
VALUES (56, '2024-01-22 11:00:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/check-db', 200, '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (57, '2024-01-22 11:00:56', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (58, '2024-01-22 11:01:07', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (59, '2024-01-22 11:01:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (60, '2024-01-22 11:02:34', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (61, '2024-01-22 11:02:38', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '104.234.0.191', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (62, '2024-01-22 11:03:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '服务器有点呆。。。', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/logout', 200, '{\"code\":0,\"message\":\"服务器有点呆。。。\"}');
INSERT INTO `sys_log_operation`
VALUES (63, '2024-01-22 11:03:04', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/check-db', 200, '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (64, '2024-01-22 11:03:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (65, '2024-01-22 11:03:10', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (66, '2024-01-22 11:03:11', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '104.234.0.191', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (67, '2024-01-22 11:33:43', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (68, '2024-01-22 11:33:49', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (69, '2024-01-22 11:34:02', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '服务器有点呆。。。', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":0,\"message\":\"服务器有点呆。。。\"}');
INSERT INTO `sys_log_operation`
VALUES (70, '2024-01-22 11:34:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/check-db', 200, '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (71, '2024-01-22 11:34:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (72, '2024-01-22 11:34:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (73, '2024-01-22 11:34:12', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (74, '2024-01-22 11:35:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (75, '2024-01-22 11:35:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (76, '2024-01-22 11:35:47', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (77, '2024-01-22 11:35:47', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (78, '2024-01-22 11:36:09', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (79, '2024-01-22 11:36:10', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (80, '2024-01-22 11:36:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (81, '2024-01-22 11:36:18', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (82, '2024-01-22 11:36:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (83, '2024-01-22 11:36:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (84, '2024-01-22 11:36:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (85, '2024-01-22 11:36:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (86, '2024-01-22 11:36:26', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (87, '2024-01-22 11:36:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (88, '2024-01-22 11:36:30', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (89, '2024-01-22 11:36:33', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/role/get-role-list', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (90, '2024-01-22 11:36:36', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (91, '2024-01-22 11:36:36', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (92, '2024-01-22 11:36:40', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (93, '2024-01-22 11:36:53', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-backend/get-config-backend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (94, '2024-01-22 11:37:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-backend/get-config-backend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (95, '2024-01-22 11:37:21', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-backend/edit-config-backend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (96, '2024-01-22 11:37:23', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (97, '2024-01-22 11:37:25', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (98, '2024-01-22 11:37:25', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (99, '2024-01-22 11:37:28', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (100, '2024-01-22 11:38:24', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/upload/upload-avatar', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (101, '2024-01-22 11:38:55', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'test001编辑成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/edit-user', 200, '{\"code\":1,\"message\":\"test001编辑成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (102, '2024-01-22 11:38:55', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (103, '2024-01-22 11:39:07', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/role/get-role-list', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (104, '2024-01-22 11:39:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (105, '2024-01-22 11:39:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (106, '2024-01-22 11:39:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (107, '2024-01-22 11:39:24', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (108, '2024-01-22 11:39:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (109, '2024-01-22 11:39:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (110, '2024-01-22 11:39:30', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (111, '2024-01-22 11:39:30', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (112, '2024-01-22 11:40:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (113, '2024-01-22 11:40:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (114, '2024-01-22 11:40:29', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (115, '2024-01-22 11:40:32', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (116, '2024-01-22 11:40:36', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (117, '2024-01-22 11:40:37', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (118, '2024-01-22 11:43:15', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (119, '2024-01-22 11:50:33', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (120, '2024-01-22 11:50:34', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (121, '2024-01-22 11:50:39', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (122, '2024-01-22 11:50:40', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (123, '2024-01-22 11:50:42', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (124, '2024-01-22 11:50:43', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (125, '2024-01-22 11:51:00', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (126, '2024-01-22 11:51:00', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (127, '2024-01-22 11:51:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (128, '2024-01-22 11:51:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (129, '2024-01-22 11:51:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (130, '2024-01-22 11:51:59', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/role/get-role-list', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (131, '2024-01-22 11:52:01', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (132, '2024-01-22 11:52:01', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (133, '2024-01-22 11:52:04', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (134, '2024-01-22 11:52:43', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/upload/upload-avatar', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (135, '2024-01-22 11:52:49', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin编辑成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/edit-user', 200, '{\"code\":1,\"message\":\"admin编辑成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (136, '2024-01-22 11:52:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (137, '2024-01-22 11:52:58', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (138, '2024-01-22 11:53:20', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (139, '2024-01-22 11:53:20', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (140, '2024-01-22 11:53:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (141, '2024-01-22 11:53:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (142, '2024-01-22 11:53:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (143, '2024-01-22 11:53:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (144, '2024-01-22 11:53:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (145, '2024-01-22 11:53:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (146, '2024-01-22 11:53:29', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (147, '2024-01-22 11:53:29', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (148, '2024-01-22 11:53:31', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (149, '2024-01-22 11:53:31', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (150, '2024-01-22 11:53:32', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (151, '2024-01-22 11:53:33', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (152, '2024-01-22 11:54:11', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (153, '2024-01-22 11:54:11', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (154, '2024-01-22 11:54:18', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (155, '2024-01-22 11:54:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (156, '2024-01-22 12:02:42', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (157, '2024-01-22 12:02:43', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (158, '2024-01-22 12:02:48', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (159, '2024-01-22 12:02:48', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (160, '2024-01-22 12:02:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (161, '2024-01-22 12:02:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (162, '2024-01-22 12:03:04', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (163, '2024-01-22 12:03:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (164, '2024-01-22 12:03:27', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (165, '2024-01-22 12:03:34', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (166, '2024-01-22 12:03:35', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (167, '2024-01-22 12:03:55', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (168, '2024-01-22 12:03:55', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (169, '2024-01-22 12:03:57', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (170, '2024-01-22 12:03:57', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (171, '2024-01-22 12:03:58', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (172, '2024-01-22 12:03:58', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (173, '2024-01-22 12:12:17', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (174, '2024-01-22 12:17:34', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (175, '2024-01-22 12:17:39', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (176, '2024-01-22 12:17:45', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '服务器有点呆。。。', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":0,\"message\":\"服务器有点呆。。。\"}');
INSERT INTO `sys_log_operation`
VALUES (177, '2024-01-22 12:17:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/check-db', 200, '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (178, '2024-01-22 12:17:47', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (179, '2024-01-22 12:17:51', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (180, '2024-01-22 12:17:52', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (181, '2024-01-22 12:18:02', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/check-db', 200, '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (182, '2024-01-22 12:18:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (183, '2024-01-22 12:18:08', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (184, '2024-01-22 12:18:12', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (185, '2024-01-22 12:18:14', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (186, '2024-01-22 12:18:25', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (187, '2024-01-22 12:18:40', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (188, '2024-01-22 12:18:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (189, '2024-01-22 12:19:01', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '服务器有点呆。。。', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":0,\"message\":\"服务器有点呆。。。\"}');
INSERT INTO `sys_log_operation`
VALUES (190, '2024-01-22 12:19:02', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/check-db', 200, '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (191, '2024-01-22 12:19:02', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (192, '2024-01-22 12:19:08', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (193, '2024-01-22 12:19:08', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (194, '2024-01-22 12:19:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (195, '2024-01-22 12:19:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (196, '2024-01-22 12:20:00', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (197, '2024-01-22 12:20:00', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (198, '2024-01-22 12:20:04', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (199, '2024-01-22 12:20:11', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (200, '2024-01-22 12:20:12', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (201, '2024-01-22 12:20:13', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (202, '2024-01-22 12:20:15', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (203, '2024-01-22 12:20:20', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (204, '2024-01-22 12:20:26', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (205, '2024-01-22 12:20:26', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (206, '2024-01-22 12:20:28', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (207, '2024-01-22 12:20:43', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (208, '2024-01-22 12:20:56', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (209, '2024-01-22 12:21:02', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (210, '2024-01-22 12:21:03', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (211, '2024-01-22 12:21:03', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (212, '2024-01-22 12:21:09', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (213, '2024-01-22 12:21:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (214, '2024-01-22 12:21:14', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (215, '2024-01-22 12:21:17', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (216, '2024-01-22 12:21:20', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (217, '2024-01-22 12:21:25', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (218, '2024-01-22 12:21:30', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (219, '2024-01-22 12:21:44', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (220, '2024-01-22 12:21:51', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (221, '2024-01-22 12:22:17', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (222, '2024-01-22 12:22:24', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (223, '2024-01-22 12:22:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (224, '2024-01-22 12:22:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (225, '2024-01-22 12:22:31', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (226, '2024-01-22 12:22:35', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (227, '2024-01-22 12:22:39', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (228, '2024-01-22 12:23:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (229, '2024-01-22 12:23:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (230, '2024-01-22 12:23:39', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-backend/get-config-backend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (231, '2024-01-22 12:23:56', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (232, '2024-01-22 12:23:56', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (233, '2024-01-22 12:23:59', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (234, '2024-01-22 12:24:47', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/upload/upload-avatar', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (235, '2024-01-22 12:25:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'test001编辑成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/edit-user', 200, '{\"code\":1,\"message\":\"test001编辑成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (236, '2024-01-22 12:25:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (237, '2024-01-22 12:26:01', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (238, '2024-01-22 12:26:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-backend/get-config-backend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (239, '2024-01-22 14:48:44', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (240, '2024-01-22 14:48:45', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (241, '2024-01-22 14:48:48', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (242, '2024-01-22 14:48:50', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (243, '2024-01-22 14:48:51', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (244, '2024-01-22 14:48:52', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (245, '2024-01-22 14:48:58', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (246, '2024-01-22 14:49:03', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (247, '2024-01-22 14:49:03', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (248, '2024-01-22 14:49:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (249, '2024-01-22 14:49:24', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (250, '2024-01-22 14:49:37', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (251, '2024-01-22 14:49:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (252, '2024-01-22 14:49:47', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (253, '2024-01-22 14:49:52', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/api/get-api-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (254, '2024-01-22 14:49:58', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (255, '2024-01-22 14:50:06', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (256, '2024-01-22 14:57:18', NULL, NULL, NULL, NULL, 1, 'yesNo_no', NULL, '您已被强制下线！', NULL,
        '117.136.15.5', 'POST', '/public/check-db', 200, '{\"code\":0,\"message\":\"您已被强制下线！\"}');
INSERT INTO `sys_log_operation`
VALUES (257, '2024-01-22 14:57:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (258, '2024-01-22 14:57:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (259, '2024-01-22 14:57:27', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '117.136.15.5', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (260, '2024-01-22 14:57:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'java.io.IOException: Broken pipe', 'anonymousUser', '117.136.15.5', 'POST', '/public/get-dict-all', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"java.io.IOException: Broken pipe\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (261, '2024-01-22 14:57:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (262, '2024-01-22 14:57:33', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (263, '2024-01-22 14:57:34', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (264, '2024-01-22 16:42:05', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '117.136.15.5', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (265, '2024-01-22 16:42:17', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '117.136.15.5', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (266, '2024-01-22 16:42:18', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (267, '2024-01-22 16:42:31', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (268, '2024-01-22 16:42:36', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (269, '2024-01-22 16:42:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (270, '2024-01-22 16:43:12', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (271, '2024-01-22 16:43:35', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (272, '2024-01-22 16:43:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (273, '2024-01-22 16:44:47', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (274, '2024-01-22 16:44:57', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (275, '2024-01-22 16:45:09', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (276, '2024-01-22 16:45:10', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (277, '2024-01-22 16:45:16', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (278, '2024-01-22 16:45:23', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (279, '2024-01-22 16:46:05', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改昵称成功.', 'SuperAdmin',
        '117.136.15.5', 'POST', '/user/change-nickname', 200, '{\"code\":1,\"message\":\"admin修改昵称成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (280, '2024-01-22 19:34:21', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '222.249.236.26', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (281, '2024-01-22 19:34:22', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '222.249.236.26', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (282, '2024-01-22 19:34:23', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'java.io.IOException: Broken pipe', 'anonymousUser', '222.249.236.26', 'POST', '/public/get-dict-all', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"java.io.IOException: Broken pipe\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (283, '2024-01-23 07:09:35', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (284, '2024-01-23 07:09:36', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (285, '2024-01-23 07:09:42', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (286, '2024-01-23 07:09:46', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (287, '2024-01-23 07:09:59', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (288, '2024-01-23 07:10:04', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (289, '2024-01-23 07:10:04', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (290, '2024-01-23 07:10:22', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (291, '2024-01-23 07:10:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (292, '2024-01-23 07:10:58', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (293, '2024-01-23 07:11:14', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (294, '2024-01-23 07:11:14', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (295, '2024-01-23 07:11:23', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (296, '2024-01-23 07:11:23', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (297, '2024-01-23 07:11:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '该账号已在别处登录！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200,
        '{\"code\":0,\"message\":\"该账号已在别处登录！\"}');
INSERT INTO `sys_log_operation`
VALUES (298, '2024-01-23 07:11:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (299, '2024-01-23 07:36:06', NULL, NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'Token eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsIlJlZnJlc2hBdCI6MTcwNTk1MDQzOTAzMiwiaWF0IjoxNzA1OTE0NDQyLCJleHAiOjE3MDU5NTA0NDJ9.QvniK-UoyTgrW0nw1mdEBACUp9VTZNvFjJT_9oDtGgM',
        NULL, '223.104.217.16', 'POST', '/user/get-user-menu', 511,
        '{\"code\":0,\"message\":\"token已失效，登录过期\"}');
INSERT INTO `sys_log_operation`
VALUES (300, '2024-01-23 07:36:07', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (301, '2024-01-23 07:36:07', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (302, '2024-01-23 07:36:12', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (303, '2024-01-23 07:36:13', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (304, '2024-01-23 07:36:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (305, '2024-01-23 07:36:36', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (306, '2024-01-23 07:36:42', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (307, '2024-01-23 07:36:55', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (308, '2024-01-23 07:37:12', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (309, '2024-01-23 07:37:12', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (310, '2024-01-23 07:37:20', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (311, '2024-01-23 07:37:31', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (312, '2024-01-23 07:37:37', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (313, '2024-01-23 07:38:01', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (314, '2024-01-23 07:38:07', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (315, '2024-01-23 07:38:14', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (316, '2024-01-23 07:38:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (317, '2024-01-23 07:38:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (318, '2024-01-23 07:38:49', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/role/get-role-list', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (319, '2024-01-23 07:38:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (320, '2024-01-23 07:39:00', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/kick-online-user', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (321, '2024-01-23 07:39:01', NULL, NULL, NULL, NULL, 1, 'yesNo_no', NULL, '您已被强制下线！', NULL,
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200,
        '{\"code\":0,\"message\":\"您已被强制下线！\"}');
INSERT INTO `sys_log_operation`
VALUES (322, '2024-01-23 07:39:18', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (323, '2024-01-23 07:39:25', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (324, '2024-01-23 07:39:25', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (325, '2024-01-23 07:39:29', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (326, '2024-01-23 07:40:42', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (327, '2024-01-23 07:40:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (328, '2024-01-23 07:40:59', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (329, '2024-01-23 07:41:00', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (330, '2024-01-23 07:41:06', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (331, '2024-01-23 07:41:06', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (332, '2024-01-23 07:41:06', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (333, '2024-01-23 07:41:10', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (334, '2024-01-23 07:41:11', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (335, '2024-01-23 07:41:17', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (336, '2024-01-23 07:41:18', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (337, '2024-01-23 07:41:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (338, '2024-01-23 07:41:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'java.io.IOException: Broken pipe', 'anonymousUser', '223.104.217.16', 'POST', '/public/get-dict-all', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"java.io.IOException: Broken pipe\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (339, '2024-01-23 07:41:19', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (340, '2024-01-23 07:41:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'java.io.IOException: Broken pipe', 'anonymousUser', '223.104.217.16', 'POST', '/public/get-dict-all', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"java.io.IOException: Broken pipe\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (341, '2024-01-23 07:41:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (342, '2024-01-23 07:41:24', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (343, '2024-01-23 07:41:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL,
        'java.io.IOException: Broken pipe', 'anonymousUser', '223.104.217.16', 'POST', '/public/get-dict-all', 422,
        '{\"headers\":{},\"body\":{\"body\":[\"java.io.IOException: Broken pipe\"]},\"status_code\":\"UNPROCESSABLE_ENTITY\",\"status_code_value\":422}');
INSERT INTO `sys_log_operation`
VALUES (344, '2024-01-23 07:41:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (345, '2024-01-23 07:41:26', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (346, '2024-01-23 07:41:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (347, '2024-01-23 07:41:32', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (348, '2024-01-23 07:41:34', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (349, '2024-01-23 07:41:35', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (350, '2024-01-23 07:41:37', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (351, '2024-01-23 07:41:43', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (352, '2024-01-23 07:42:32', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/upload/upload-banner-image', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (353, '2024-01-23 07:42:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (354, '2024-01-23 07:42:48', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (355, '2024-01-23 07:43:19', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (356, '2024-01-23 07:43:21', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (357, '2024-01-23 07:43:27', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (358, '2024-01-23 07:43:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (359, '2024-01-23 07:43:28', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (360, '2024-01-23 07:43:36', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (361, '2024-01-23 07:43:36', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (362, '2024-01-23 07:43:38', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '数据库初始化成功！',
        'anonymousUser', '223.104.217.16', 'POST', '/public/check-db', 200,
        '{\"code\":1,\"message\":\"数据库初始化成功！\"}');
INSERT INTO `sys_log_operation`
VALUES (363, '2024-01-23 07:43:38', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-dict-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (364, '2024-01-23 07:43:43', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (365, '2024-01-23 07:43:44', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-config-backend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (366, '2024-01-23 07:43:47', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (367, '2024-01-23 07:43:48', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (368, '2024-01-23 07:43:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (369, '2024-01-23 07:43:53', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (370, '2024-01-23 07:44:00', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (371, '2024-01-23 07:44:00', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (372, '2024-01-23 07:44:06', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (373, '2024-01-23 07:44:31', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'anonymousUser',
        '223.104.217.16', 'POST', '/public/get-captcha', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (374, '2024-01-23 07:44:47', 'anonymousUser', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '登录成功.',
        'anonymousUser', '223.104.217.16', 'POST', '/public/login', 200, '{\"code\":1,\"message\":\"登录成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (375, '2024-01-23 07:44:48', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (376, '2024-01-23 07:44:51', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (377, '2024-01-23 08:05:31', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (378, '2024-01-23 13:50:59', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (379, '2024-01-23 13:51:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (380, '2024-01-23 13:51:07', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (381, '2024-01-23 13:51:08', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/dept/get-dept-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (382, '2024-01-23 13:51:13', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '查找成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/query-user-by-id', 200, '{\"code\":1,\"message\":\"查找成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (383, '2024-01-23 13:51:34', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/upload/upload-avatar', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (384, '2024-01-23 13:51:42', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin编辑成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/edit-user', 200, '{\"code\":1,\"message\":\"admin编辑成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (385, '2024-01-23 13:51:42', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (386, '2024-01-23 13:51:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-backend/get-config-backend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (387, '2024-01-23 13:51:52', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (388, '2024-01-23 13:52:39', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (389, '2024-01-23 13:52:41', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (390, '2024-01-23 13:52:46', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/upload/upload-banner-image', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (391, '2024-01-23 13:52:50', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin修改成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/edit-config-frontend', 200,
        '{\"code\":1,\"message\":\"admin修改成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (392, '2024-01-23 13:52:52', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/get-config-frontend-all', 200, '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (393, '2024-01-23 13:53:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, '获取用户菜单成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user/get-user-menu', 200, '{\"code\":1,\"message\":\"获取用户菜单成功.\"}');
INSERT INTO `sys_log_operation`
VALUES (394, '2024-01-23 13:53:06', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (395, '2024-01-23 13:53:07', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (396, '2024-01-23 13:53:16', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (397, '2024-01-23 13:53:22', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-login-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (398, '2024-01-23 13:53:34', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (399, '2024-01-23 13:53:42', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/log/get-log-operation-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (400, '2024-01-23 13:53:48', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success', 'SuperAdmin',
        '223.104.217.16', 'POST', '/user-online/get-user-online-list', 200, '{\"code\":1,\"message\":\"Success\"}');
INSERT INTO `sys_log_operation`
VALUES (401, '2024-01-23 13:53:54', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'Success.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/config-frontend/get-config-frontend-list', 200,
        '{\"code\":1,\"message\":\"Success.\"}');
INSERT INTO `sys_log_operation`
VALUES (402, '2024-01-23 13:54:03', 'admin', NULL, NULL, NULL, 1, 'yesNo_no', NULL, 'admin 下线成功.', 'SuperAdmin',
        '223.104.217.16', 'POST', '/public/logout', 200, '{\"code\":1,\"message\":\"admin 下线成功.\"}');
...
VALUES (1, '2023-12-04 13:02:17', 'admin', '2024-01-23 13:51:41', 'admin', NULL, 1, 'yesNo_yes', 'onOff_on',
        'Be the change you want to see in the world.', 'admin', '陈佰亿', 'SuperAdmin',
        '$2a$10$jGr2rP6BJdTR7QPx8RNVge2RxcbsJJgWXtUKf2cMz4RATXrx1/6wy',
        'gqa-upload:avatar/cilicili/80f2fe0ed92a4c63acbb182a80e779d7_20240123135134301.jpg', 'gender_male',
        '1234567890', '11111111111', b'1');
INSERT INTO `sys_user`
VALUES (2, '2024-01-05 00:03:39', 'admin', '2024-01-22 12:25:54', 'admin', NULL, NULL, 'yesNo_no', 'onOff_on',
        '测试人员', 'test001', '爱修bug的小猫', '小晨晨',
        '$2a$10$59cQPuEzwzoabaDh35ZtY.r7qFyImiAhcD2.YnBXgvAyFiHB6Weo.',
        'gqa-upload:avatar/admin/64735c5c8c97436192fae19600bd5a71_20240122122446336.png', 'gender_male', '19882026235',
        '2332869185@qq.com', b'1');
